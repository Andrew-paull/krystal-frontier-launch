        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="inline-block px-4 py-2 bg-secondary/20 text-secondary rounded-full text-sm font-medium mb-8">
              Dubai-Based Investment Enterprise
            </span>
          </motion.div>
          ...
          >
            Atlas Frontier Corp{" "}
            <span className="text-gradient-gold">L.L.C – FZ</span>
          </motion.h1>
          ...
          >
            A Dubai-based investment enterprise and management firm focused on identifying, 
            structuring, and managing high-value opportunities across emerging and established markets.
          </motion.p>
